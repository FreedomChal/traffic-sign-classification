...
Here is an exploratory visualization of the data set. It shows 5 labeled images with transformations
...
As a last step, I normalized the image data because otherwise the gradients would get extreme.

Here is an example of an original image and an augmented image:

![alt text][image3]

The difference between the original data set and the augmented data set is that the colors are blurred to be less extreme, and the image is warped. 
